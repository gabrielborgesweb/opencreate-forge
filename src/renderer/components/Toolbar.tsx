...
import { MousePointer2, Square, Brush, Pencil, Eraser, Type } from 'lucide-react';
...
const Toolbar: React.FC = () => {
  ...
  return (
    <div className="toolbar" style={{ display: 'flex', flexDirection: 'column', padding: '0.5rem', gap: '0.5rem' }}>
      {tools.map((tool) => (
        <button
          key={tool.id}
